...
def generate_material_list_json(bin_id):
    
    if bin_id >= 1 and bin_id <= 6 or bin_id >= 27 and bin_id <= 32:
        materialList = generate_plate_info_json(1,7, 'Na01.01') 
    elif bin_id >= 7 and bin_id <= 8:
        materialList = generate_plate_info_json(1,10, "Za01.01") 
    elif bin_id >= 9 and bin_id <= 10:
        materialList = generate_plate_info_json(1,10, "Za01.02")
    elif bin_id >= 11 and bin_id <= 12:
        materialList = generate_plate_info_json(1,10, "Za01.03")  
    elif bin_id >= 13 and bin_id <= 14:
        materialList = generate_plate_info_json(1,10, "Za02.01") 
    elif bin_id >= 15 and bin_id <= 16:
        materialList = generate_plate_info_json(1,10, "Za02.02")
    elif bin_id >= 17 and bin_id <= 18:
        materialList = generate_plate_info_json(1,10, "Za02.03") 
    elif bin_id >= 19 and bin_id <= 20:
        materialList = generate_plate_info_json(1,10, "Za03.01") 
    elif bin_id >= 21 and bin_id <= 22:
        materialList = generate_plate_info_json(1,10, "Za03.02")
    elif bin_id >= 23 and bin_id <= 24:
        materialList = generate_plate_info_json(1,10, "Za03.03")       
    elif bin_id == 25 or bin_id == 51:
