...
class Ui_TCP(QDialog):
    ...
    def ui_translate(self, ):
        ...
        self.label_written.setText(self._translate("TCP-UDP", "Written by William Zhang"))
    ...
    def all_send(self):
        ...
        if self.link is False:
            ...
            try:
                send_msg = (str(self.textEdit_send.toPlainText())).encode('gbk')
                if self.comboBox_tcp.currentIndex() == 0:
                    for client, address in self.client_socket_list:
    ...
    def web_send_msg(self):
        ...
        return response_header.encode('gbk'), response_body
